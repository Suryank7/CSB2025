...
// const myName = React.createElement("h3", { style: { color: "red" } }, "Suryank Malik");
// const header = React.createElement("div", {}, pic, myName);
// const wrapper = React.createElement('div', {}, h2, Headers, ul);
// root.render(wrapper);
